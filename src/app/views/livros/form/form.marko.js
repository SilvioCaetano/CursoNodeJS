// Compiled using marko@4.18.16 - DO NOT EDIT
"use strict";
...
function render(input, out, __component, component, state) {
  ...
  out.w("<div class=\"form-group\"><label for=\"titulo\">Titulo:</label><input type=\"text\" id=\"titulo\" name=\"titulo\"" +
    ...
    " placeholder=\"coloque o titulo\" class=\"form-control\"></div><div class=\"form-group\"><label for=\"preco\">Preço:</label><input type=\"text\" id=\"preco\" name=\"preco\"" +
    marko_attr("value", data.livro.preco) +
    " placeholder=\"150.25\" class=\"form-control\"></div><div class=\"form-group\"><label for=\"descricao\">Descrição:</label><textarea cols=\"20\" rows=\"10\" id=\"descricao\" name=\"descricao\" placeholder=\"fale sobre o livro\" class=\"form-control\">" +
