...
function writeInitComponentsCode(fromOut, targetOut, shouldIncludeAll) {
    ...
    targetOut.write("<script" + nonceAttr + ">" + componentGlobalKey + "=(window." + componentGlobalKey + "||[]).concat(" + safeJSON(warp10.stringify(renderedComponents)) + ")||" + componentGlobalKey + "</script>");
}
